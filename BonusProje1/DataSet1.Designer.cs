...
namespace BonusProje1 {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class TBLOGRENCILERDataTable : global::System.Data.TypedTableBase<TBLOGRENCILERRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TBLOGRENCILERRow AddTBLOGRENCILERRow(string OGRAD, string OGRCINSIYET, string OGRSOYAD, string KULUPAD) {
            ...
            public string KULUPAD {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("\'TBLOGRENCILER\' tablosundaki \'KULUPAD\' sütunun değeri DBNull.", e);
                    }
                }
                set {
            ...
            public int OGRENCIID {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("\'TBLNOTLAR\' tablosundaki \'OGRENCIID\' sütunun değeri DBNull.", e);
                    }
                }
                set {
...
namespace BonusProje1.DataSet1TableAdapters {
    ...
    public partial class TBLOGRENCILERTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT        TBLOGRENCILER.OGRID, TBLOGRENCILER.OGRAD, TBLOGRENCILER.OGRCINSIYET" +
                ", TBLOGRENCILER.OGRSOYAD, TBLKULUPLER.KULUPAD\r\nFROM            TBLOGRENCILER INN" +
                "ER JOIN\r\n                         TBLKULUPLER ON TBLOGRENCILER.OGRKULUP = TBLKUL" +
                "UPLER.KULUPID";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"SELECT        TBLOGRENCILER.OGRID, TBLOGRENCILER.OGRAD, TBLOGRENCILER.OGRCINSIYET, TBLOGRENCILER.OGRSOYAD, TBLKULUPLER.KULUPAD
